        ...
        <div x-show="activeFormTab === 'input'" class="space-y-5">
            ...
            <template x-if="currentForm === 'tanda'">
                <div class="space-y-4">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-white mb-1">Isi Catatan</label>
                    ...
                    <template x-for="item in getFilteredList()" :key="item.id">
                        <li
                            ...
                            <div class="flex flex-col overflow-hidden">
                                <span class="text-gray-700 dark:text-gray-200 font-medium truncate"
                            ...
                            <div class="flex items-center space-x-1 shrink-0">
                                <button type="button" @click="editDataItem(item)"
                                    class="text-blue-500 hover:bg-blue-50 p-1.5 rounded-md transition-colors"><i
                                        class="fas fa-pencil-alt"></i></button>
                                <button type="button" @click="deleteDataItem(item.id)"
                                    class="text-red-500 hover:bg-red-50 p-1.5 rounded-md transition-colors"><i
