    ...
    <div class="py-12">
        <div class="max-w-full mx-auto sm:px-6 lg:px-8">
            ...
            <div class="container mx-auto" x-data="{
                ...
                <div x-show="activeTab === 'jadwal'" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform -translate-y-4" x-transition:enter-end="opacity-100 transform translate-y-0">
                    <div class="bg-white dark:bg-gray-800 p-4 sm:p-6 rounded-xl shadow-lg mb-6">
                        <div class="flex flex-col md:flex-row md:justify-between md:items-center gap-6">
                            <div class="relative inline-block text-left" x-data="{ showAddMenu: false, currentForm: '' }">
                                <button @click="showAddMenu = !showAddMenu" type="button"
                                    class="inline-flex justify-center w-full rounded-md border border-transparent shadow-sm px-4 py-2 bg-green-600 text-base font-medium text-white hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 dark:ring-offset-gray-800">
                                ...
                                <div x-show="showAddMenu" @click.away="showAddMenu = false" x-transition
                                    ...
                                    <div class="py-1" role="menu">
                                        <a href="#" @click.prevent="currentForm = 'mapel'; showAddMenu = false"
                                        ...
                                        <a href="#" @click.prevent="currentForm = 'guru'; showAddMenu = false"
                                            class="block px-4 py-2 text-sm text-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-600"
                                            role="menuitem">
                                            <i class="fas fa-chalkboard-teacher w-5 mr-2"></i> Guru
                                        </a>
                                        <a href="#" @click.prevent="currentForm = 'ruang'; showAddMenu = false"
                                            class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-600"
                                            role="menuitem">
                                        ...
                                        <a href="#" @click.prevent="currentForm = 'siswa'; showAddMenu = false"
                                            class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-600"
                                            role="menuitem">
                    ...
                    <div class="overflow-x-auto shadow-md rounded-lg">
                        <table class="min-w-full w-full border-collapse table-fixed">
                            <thead class="bg-gray-100 dark:bg-gray-700/80">
                                <tr>
                                    <th
                                        class="border border-gray-300 dark:border-gray-600 p-3 text-center uppercase text-xs tracking-wider font-semibold text-gray-600 dark:text-gray-300 w-24 lg:w-32">
                                        Sesi
                                    </th>
                                    @foreach ($haris as $hari)
                                        <th
                                            class="border border-gray-300 dark:border-gray-600 p-3 text-center uppercase text-xs tracking-wider font-semibold text-gray-600 dark:text-gray-300 min-w-[200px]">
                                            {{ $hari->name }}
                                        </th>
                                    @endforeach
                                </tr>
                                            ...
                                            <td class="kanban-slot border border-gray-200 dark:border-gray-600 p-2 align-top h-64 relative cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-900/40 transition-colors duration-150"
                                                ...
                                                @if (isset($jadwals[$hari->id][$sesi->id]))
                                                    @foreach ($jadwals[$hari->id][$sesi->id] as $groupedClass)
                                                        ...
                                                        <div class="kanban-card group relative bg-white/90 dark:bg-gray-700/90 backdrop-blur-sm p-2.5 mb-2 rounded-lg shadow border-l-4 text-sm cursor-move
                                                            ...
                                                            <button
                                                                ...
                                                                "
                                                                class="absolute top-1 right-1 p-1.5 rounded-full bg-gray-100 dark:bg-gray-600 text-gray-500 dark:text-gray-300 hover:bg-blue-100 hover:text-blue-600 dark:hover:bg-blue-500 dark:hover:text-white
                                                            ...
                                                            <span
                                                                class="block text-gray-500 dark:text-gray-400 text-xs mt-1">
                ...
                <div x-show="activeTab === 'berita'" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform -translate-y-4" x-transition:enter-end="opacity-100 transform translate-y-0" style="display: none;">
                    @include('admin.card')
                </div>
                ...
                <div x-show="showModal" x-transition:enter="ease-out duration-300" x-transition:enter-start="opacity-0"
                    ...
                    <div @click.stop
                        ...
                        <div class="flex justify-between items-center p-4 border-b dark:border-gray-700">
                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Edit Jadwal</h3>
                        ...
                        <form id="editJadwalForm">
                            <div class="p-6 space-y-4 max-h-[70vh] overflow-y-auto">
                                <div>
                                    <label for="editMapel"
                                        class="block text-sm font-medium text-gray-700 dark:text-gray-300">Mata
                                        Pelajaran</label>
                                ...
                                <div>
                                    <label for="editRuang"
                                        class="block text-sm font-medium text-gray-700 dark:text-gray-300">Ruang</label>
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Siswa
                                        Terpilih</label>
                                            ...
                                            <template x-for="siswa in selectedSiswas()" :key="siswa.id">
                                                <li
                                                    ...
                                                    <button @click.prevent="removeSiswa(siswa.id)" type="button"
                                                        class="font-medium text-red-500 hover:text-red-700 dark:text-red-400 dark:hover:text-red-300 text-xs">
                                                        Hapus
                                                    </button>
                                                </li>
                                            </template>
                                    ...
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mt-3">Cari
                                        & Tambah Siswa</label>
                                    <div class="relative">
                                        <input type="text" x-model.debounce.300ms="searchModalSiswa"
                                            ...
                                            class="mt-1 w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100">
                ...
                <div x-show="showAddJadwalModal" x-transition:enter="ease-out duration-300" x-transition:enter-start="opacity-0"
                    x-transition:enter-end="opacity-100" x-transition:leave="ease-in duration-200"
                    x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0"
                    class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black bg-opacity-50"
                    style="display: none;">
    ...
    @push('scripts')
        ...
        <script>
            function saveNewData() {
                ...
                .then(data => {
                    if (data.status === 'success') {
                        alert('Data ' + formType + ' berhasil ditambahkan! Halaman akan dimuat ulang.');
                        window.location.reload();
                    } else {
