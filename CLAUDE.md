...
**The brand is emerald green — the owner has confirmed it twice.** `primary` is emerald, `accent` teal. An earlier pass tried blue/purple and was rejected outright ("tema nya kenapa ungu? emerald hijau saja"). Do not reintroduce blue, purple, violet, indigo or fuchsia as chrome.
